...
import Bitbucket from "@figshare/fcl/icons/bitbucket/index";
...
import FTPIntegration from "@figshare/fcl/icons/ftpIntegration/index";
...
>
  <div style={{ display: "flex", margin: "48px", maxWidth: "700px", alignItems: "center" }}>
    <FTPIntegration style={ { width: "48px", height: "48px", margin: "0 24px" } } />
  </div>
</Story>
...
import GitHub from "@figshare/fcl/icons/github/index";
...
import GitLab from "@figshare/fcl/icons/gitlab/index";
