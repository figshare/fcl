  ...
  render() {
    return (
      ...
      >
        ...
        <path
          clipRule="evenodd"
          d="M7.5 13a.5.5 0 0 0-.5.5V16H4.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5H7v2.5a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5V18h2.5a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5H9v-2.5a.5.5 0 0 0-.5-.5h-1z"
          fillRule="evenodd"
        />
      </svg>
    );
